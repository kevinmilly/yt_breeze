...
@Component({
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="tab-pane" *ngIf="activeTab() === 'terms'">
            ...
            <h3>API Key Usage</h3>
            <p><strong>Bring Your Own Key (BYOK):</strong> If you provide your own API key for any third-party provider, you are solely responsible for your API billing and usage charges.</p>
            ...
            <p>This service may use third-party providers for transcript extraction, metadata lookup, and AI analysis. We do not control those providers and are not responsible for outages, changes, or discontinuations of any third-party services.</p>
          ...
          <div class="tab-pane" *ngIf="activeTab() === 'disclaimer'">
            ...
            <ul>
              ...
              <li><strong>API Downtime:</strong> We are not responsible for outages caused by third-party providers or other external services.</li>
  ...
  styles: [`
    ...
    .modal-body {
      flex: 1 1 auto;
      /* Ensure body can scroll independently when content is long */
